...
{
    Q_OBJECT
    Q_PROPERTY(qreal elementexpancion READ elementexpancion WRITE setElementexpancion)
    ...
    Q_PROPERTY(QSize scaleSize READ scaleSize WRITE setScaleSize NOTIFY scaleSizeChanged)

public:
    explicit CirleButonEditConvert(const QString &text,
                                   qreal raidus,
                                   qreal centerx,
                                   qreal centery,
                                   const QChar &icon,
